...
if __name__ == '__main__':
    ...
    #train_model_path = os.path.join(cur_dir, './carIdentityData/model/plate_recongnize/model.ckpt-510')
    #model_path = os.path.join(cur_dir,'./carIdentityData/model/plate_recongnize/model.ckpt-510-510')
    data_dir = os.path.join(cur_dir, '..\\images\\cnn_plate_train\\')
    test_dir = os.path.join(cur_dir, '..\\images\\cnn_plate_test\\')
    train_model_path = os.path.join(cur_dir, '..\\model\\plate_recongnize\\trainmodel.ckpt')
    model_path = os.path.join(cur_dir,'..\\model\\plate_recongnize\\')
    train_flag = 1
    net = plate_cnn_net()
